...
import 'package:ytsmovies/src/widgets/trailer_section.dart';
...
class MovieDetailsState extends State<MovieDetails> {
  ...
  @override
  Widget build(BuildContext context) => _Screen(movie: widget._movie);
}

class _Screen extends StatelessWidget {
  final Movie _movie;
  const _Screen({required Movie movie}) : _movie = movie;
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        DecoratedBox(
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              ...
                              onError: (e, s) => log('backdrop image failed',
                        ...
                        if (_movie.trailer != null &&
                          ...
                          isDesktop
                              ? TrailerLauncherButton(videoId: _movie.trailer!)
                              : TrailerSection(videoId: _movie.trailer!),
